...
CPCT_PATH      := /home/monty/git/cpctelera/cpctelera/
...
CFILES     := src/Game.c src/Main.c src/LoadBitmap.c src/NullMusic.c  src/CPCRenderer.c src/CPackedFileReader.c src/Common.c
